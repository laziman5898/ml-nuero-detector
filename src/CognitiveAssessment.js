...
const CognitiveDisordersAssessment = ({
  isDark,
  setIsDark,
  previousDiagnosis,
  onComplete,
  ...
  const questions = [
    ...
    {
      id: "Family_History",
      text: "Do you have a family history of cognitive disorders?",
      options: ["Yes", "No"],
    },
    {
      id: "Substance_Use",
      text: "Do you currently use any substances that might affect cognitive function?",
      options: ["Yes", "No"],
    },
    {
      id: "Memory_Issues",
      text: "Do you experience memory problems?",
      options: ["Yes", "No"],
    },
    {
      id: "Attention_Problems",
      text: "Do you have difficulties maintaining attention?",
      options: ["Yes", "No"],
    },
    {
      id: "Problem_Solving_Difficulties",
      text: "Do you struggle with problem-solving tasks?",
      options: ["Yes", "No"],
    },
    {
      id: "Mood_Changes",
    ...
    {
      id: "Language_Issues",
      text: "Do you experience difficulties with language or communication?",
      options: ["Yes", "No"],
    },
    {
    ...
    {
      id: "Social_Isolation",
      text: "Have you experienced social withdrawal or isolation?",
      options: ["Yes", "No"],
    },
    {
      id: "Head_Injury_History",
      text: "Do you have a history of head injuries?",
      options: ["Yes", "No"],
    },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://neuro-prediction-app-f95c50a3f746.herokuapp.com/predict_cognitive",
        {
          method: "POST",
          headers: {
        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold mt-4">
              Detailed Cognitive Disorders Assessment
            </h1>
            <div
          ...
          <p className="text-lg mb-8 leading-relaxed max-w-2xl mx-auto">
            ...
            type and characteristics of potential cognitive disorders.
          </p>
          ...
          <div className={`grid md:grid-cols-2 gap-6 mb-8`}>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 text-left">
                {cognitiveDisorderTypes.map((type, index) => (
...
export default CognitiveDisordersAssessment;
