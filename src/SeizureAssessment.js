...
const SeizureDisorderAssessment = ({
  isDark,
  setIsDark,
  previousDiagnosis,
  onComplete,
  ...
  const questions = [
    ...
    {
      id: "Seizure_Awareness",
      text: "During a seizure, what is your level of awareness?",
      options: ["Fully Aware", "Partially Aware", "Not Aware"],
    },
    {
      id: "Seizure_Duration (Minutes)",
      text: "How long do your seizures typically last (in minutes)?",
      type: "number",
      min: 0,
      max: 30,
      step: 0.1,
    ...
    {
      id: "Seizure_Frequency (Per Month)",
      text: "How many seizures do you experience per month?",
      type: "number",
      min: 0,
      max: 50,
    },
    {
      id: "Muscle_Twitching",
      text: "What type of muscle movements do you experience during seizures?",
      options: ["Localized", "Generalized", "None"],
    },
    {
      id: "Warning_Sensation",
      text: "Do you experience any warning sensations before a seizure?",
      options: ["Yes", "No"],
    },
    {
      id: "Blank_Stare",
      text: "Do you experience blank stares during seizures?",
      options: ["Yes", "No"],
    },
    {
      id: "Post_Seizure_Confusion",
      text: "Do you experience confusion after a seizure?",
      options: ["Yes", "No"],
    },
    {
      id: "Seizure_Trigger",
      text: "What typically triggers your seizures?",
      options: ["Stress", "Lack of Sleep", "Alcohol", "Lights", "None"],
    },
    {
      id: "Family_History",
      text: "Do you have a family history of seizure disorders?",
      options: ["Yes", "No"],
    },
    {
    ...
    },
    {
      ...
      text: "Do you experience sleep deprivation?",
      options: ["Yes", "No"],
    },
    {
      id: "Alcohol_Use",
    ...
    {
      id: "Stress_Level (%)",
      text: "What is your current stress level (percentage)?",
      type: "number",
      min: 0,
      max: 100,
      step: 0.1,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://neuro-prediction-app-f95c50a3f746.herokuapp.com/predict_seizure",
        {
          method: "POST",
          headers: {
        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold mt-4">
              Detailed Seizure Disorder Assessment
            </h1>
            <div
          ...
          <p className="text-lg mb-8 leading-relaxed max-w-2xl mx-auto">
            Based on your initial assessment showing seizure-related symptoms,
            we'll conduct a specialized evaluation to determine the specific
            type and characteristics of your seizure disorder.
          </p>
          ...
          <div className={`grid md:grid-cols-2 gap-6 mb-8`}>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 text-left">
                {seizureDisorderTypes.map((type, index) => (
              ...
              <div className="space-y-4">
                {questions[currentSlide].type === "number" ? (
                  <input
                    ...
                    step={questions[currentSlide].step || 1}
...
export default SeizureDisorderAssessment;
