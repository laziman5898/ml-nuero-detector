...
const PsychosomaticDisordersAssessment = ({
  isDark,
  setIsDark,
  previousDiagnosis,
  onComplete,
  ...
  const psychosomaticDisorderTypes = [
    "Conversion Disorder",
  ...
  const questions = [
    ...
    {
      id: "Persistent_Physical_Symptoms",
      text: "Do you experience persistent physical symptoms without clear medical explanation?",
      options: ["Yes", "No"],
    },
    {
      id: "Motor_Symptoms",
      text: "Do you experience unexplained motor symptoms?",
      options: ["Yes", "No"],
    },
    {
      id: "Sensory_Symptoms",
      text: "Do you experience unexplained sensory symptoms?",
      options: ["Yes", "No"],
    },
    {
      id: "Seizure_Like_Episodes",
      text: "Have you experienced seizure-like episodes?",
      options: ["Yes", "No"],
    },
    {
      id: "Stress_Levels (%)",
    ...
    {
      id: "Health_Anxiety",
      text: "Do you experience excessive worry about your health?",
      options: ["Yes", "No"],
    },
    {
      id: "Trauma_History",
      text: "Do you have a history of significant trauma?",
      options: ["Yes", "No"],
    },
    {
      id: "Recent_Stressful_Events",
      text: "Have you experienced recent stressful life events?",
      options: ["Yes", "No"],
    },
    {
    ...
    {
      id: "Social_Support",
      text: "How would you describe your level of social support?",
      options: ["Low", "Moderate", "High"],
    },
    {
      id: "Coping_Mechanisms",
      text: "What is your primary coping mechanism?",
      options: [
        "Avoidance",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://neuro-prediction-app-f95c50a3f746.herokuapp.com/predict-pshyco",
        {
          method: "POST",
          headers: {
        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold mt-4">
              Detailed Psychosomatic Disorders Assessment
            </h1>
            <div
          ...
          <p className="text-lg mb-8 leading-relaxed max-w-2xl mx-auto">
            Based on your initial assessment showing psychosomatic-related
            symptoms, we'll conduct a specialized evaluation to determine the
            specific type and characteristics of potential psychosomatic
            disorders.
          </p>
          ...
          <div className={`grid md:grid-cols-2 gap-6 mb-8`}>
            ...
            >
              ...
              <ul className="space-y-3 text-left">
                ...
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-blue-500 rounded-full mr-3" />
                  Stress and coping analysis
                </li>
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-blue-500 rounded-full mr-3" />
                  Emotional and physiological interactions
                </li>
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-blue-500 rounded-full mr-3" />
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 text-left">
                {psychosomaticDisorderTypes.map((type, index) => (
...
export default PsychosomaticDisordersAssessment;
