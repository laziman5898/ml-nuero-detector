...
const MovementDisorderAssessment = ({
  isDark,
  setIsDark,
  previousDiagnosis,
  onComplete,
  ...
  const questions = [
    ...
    {
      id: "Family_History",
      text: "Do you have a family history of movement disorders?",
      options: ["Yes", "No"],
    },
    {
      id: "Tremor",
    ...
    {
      id: "Tremor_Type",
      text: "What type of tremor do you experience?",
      options: ["Resting", "Action", "None"],
    },
    {
      id: "Bradykinesia",
      text: "Do you experience slowness of movement?",
      options: ["Yes", "No"],
    },
    {
      id: "Muscle_Rigidity",
      text: "Do you experience muscle stiffness or rigidity?",
      options: ["Yes", "No"],
    },
    {
      id: "Balance_Issues",
      text: "Do you have problems with balance?",
      options: ["Yes", "No"],
    },
    {
      id: "Gait_Abnormality",
      text: "Do you experience changes in your walking pattern?",
      options: ["Yes", "No"],
    },
    {
      id: "Jerky_Movements",
      text: "Do you experience jerky or uncontrolled movements?",
      options: ["Yes", "No"],
    },
    {
      id: "Muscle_Twisting",
      text: "Do you experience muscle twisting or abnormal postures?",
      options: ["Yes", "No"],
    },
    {
      id: "Restless_Legs",
    ...
    {
      id: "Depression",
      text: "Do you experience depression?",
      options: ["Yes", "No"],
    },
    {
      id: "Cognitive_Impairments",
      text: "Do you experience cognitive difficulties?",
      options: ["Yes", "No"],
    },
    {
      id: "Symptom_Duration (Years)",
      text: "How long have you been experiencing symptoms (in years)?",
      type: "number",
      min: 0,
      max: 50,
    },
    {
      ...
      options: ["Stable", "Worsening", "Improving"],
    },
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://neuro-prediction-app-f95c50a3f746.herokuapp.com/predict_movement",
        {
          method: "POST",
          headers: {
      ...
      >
        ...
        >
          ...
          <p className="text-lg mb-8 leading-relaxed max-w-2xl mx-auto">
            Based on your initial assessment showing movement-related symptoms,
            we'll conduct a specialized evaluation to determine the specific
            type and characteristics of your movement disorder.
          </p>
          ...
          <div className={`grid md:grid-cols-2 gap-6 mb-8`}>
            ...
            >
              ...
              <ul className="space-y-3 text-left">
                <li className="flex items-center">
                  ...
                  Movement patterns & characteristics
                </li>
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-blue-500 rounded-full mr-3" />
                  Symptom progression
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 text-left">
                {movementDisorderTypes.map((type, index) => (
...
export default MovementDisorderAssessment;
